...
export default function DashboardPage({ user, onLogout, isDarkMode, setIsDarkMode }: DashboardPageProps) {
    ...
    const menuItems = [
        { id: 'dashboard' as MenuSection, label: t('dashboard.dashboard'), icon: <LayoutDashboard className="size-5" /> },
        { id: 'inventory' as MenuSection, label: t('dashboard.tabInventory'), icon: <Box className="size-5" />, requiresPermission: PERMISSIONS.ITEM_LIST },
        { id: 'loans' as MenuSection, label: t('dashboard.loans'), icon: <ClipboardList className="size-5" /> },
        { id: 'locations' as MenuSection, label: t('dashboard.tabLocations'), icon: <MapPinned className="size-5" />, requiresPermission: PERMISSIONS.SYSTEM_MANAGE },
        { id: 'users' as MenuSection, label: t('dashboard.tabUsers'), icon: <Users className="size-5" />, requiresPermission: PERMISSIONS.SYSTEM_MANAGE },
    ];

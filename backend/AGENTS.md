...
### API
* **Język:** Python 3.10+ (wymagane nowoczesne typowanie)
* **Framework:** FastAPI
...
### Deployment
* Zautomatyzowane środowisko oparte o **Docker** i **Docker Compose** (minimalizacja friction u deweloperów).
...
Projekt podzielony jest według domen funkcjonalnych (screaming architecture):
